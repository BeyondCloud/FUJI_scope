...
static void createPagePage0(void)
{
	...
	int2str(screenX_to_T(X_A_val),init_str);
	gwinSetText(X_A_Button,init_str,TRUE);	
	...
	int2str(screenX_to_T(X_B_val),init_str);
	gwinSetText(X_B_Button,init_str,TRUE);	
	...
	int2str(val,init_str);
	gwinSetText(X_AB_Label_Txt,init_str,TRUE);
	...
	float2str(f,init_str,3);
	gwinSetText(Y_AB_Label_Txt,init_str,TRUE);	
